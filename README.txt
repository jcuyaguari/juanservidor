...
a persistence unit "eva56canarjuanservidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva56canarjuanservidor\pom.xml":
...
artifact ("eva56canarjuanservidor.war") is already built. You can build
